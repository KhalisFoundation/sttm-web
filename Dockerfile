...
ARG NODE_ENV
ARG AUDIO_TRANSCRIPTION_URL
ARG AUDIO_TRANSCRIPTION_KEY

RUN echo "Build argument NODE_ENV value: $NODE_ENV"

ENV NODE_ENV=$NODE_ENV
ENV AUDIO_TRANSCRIPTION_URL=$AUDIO_TRANSCRIPTION_URL
ENV AUDIO_TRANSCRIPTION_KEY=$AUDIO_TRANSCRIPTION_KEY
ENV SODH_API=$SODH_API
