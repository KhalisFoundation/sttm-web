...
const MergeIcon: React.FC<IconProps> = ({ width = '1em', height = '', fill = '', ...props }: IconProps) => (
  <svg className="merge-icon" width={width} height={height} fill={fill} {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 17">
