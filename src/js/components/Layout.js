  ...
  render() {
    ...
    return online || pathname !== '/' ? (
      <div className="layout">
        ...
        {/* AI Dialog */}
        {isShowAI && this.state.isAIActive && (
            ...
            <div className="floating-dialog open">
              ...
              this.state.rephrasedTranslation.answer ? (
                <div className="floating-dialog-content">
                  ...
                  <p className="footer">Response generated by Khalis AI.</p>
                </div>
              ) : (
                <div className="floating-dialog-content loading">
                  {this.state.rephrasedTranslation &&
                    this.state.rephrasedTranslation.question && (
                      <p className="question">
                        {this.state.rephrasedTranslation.question}
                  ...
                  <img src='/assets/images/spinner-mandala.png' alt="Loading" />
                  <p>
                    {(this.state.rephrasedTranslation &&
                      this.state.rephrasedTranslation.stage) ||
                      'Asking Khalis AI…'}
                  </p>
                </div>
              )}
