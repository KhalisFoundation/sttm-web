...
const getPrefs = () =>
  Object.keys(defaultPrefs).forEach(
    key =>
...
function attachEventListeners() {
  ...
  [document.getElementById("open-mobile-menu")].forEach(
    e =>
      e &&
  ...
  // Close menu
  [document.querySelector(".top-bar-right .close a")].forEach(
    e =>
      e &&
      e.addEventListener("click", () =>
  ...
  // Share menu
  [document.getElementById("open_share_menu")].forEach(
    e =>
      e &&
      e.addEventListener("click", () =>
  ...
  [...document.querySelectorAll("#search-options select")].forEach(
    e =>
      e &&
  ...
  [document.querySelector(".gurmukhi-keyboard-toggle")].forEach(
    e =>
      e &&
      e.addEventListener("click", () =>
        [e, document.querySelector(".gurmukhi-keyboard")].forEach(f => {
          f.classList.toggle("active");
        })
      )
  );

  [document.querySelector(".clear-search-toggle")].forEach(
    e => e && e.addEventListener("click", () => ($search.value = ""))
  );
...
const showToast = (text, delay = 2500) =>
  new Promise(resolve => {
