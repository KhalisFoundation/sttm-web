...
export const TEXTS = {
  ...
  GENERIC_ERROR_DESCRIPTION: `This is really unusual. Try clearing your cache. If you still face the issue, you may want to hit the Feedback button at the bottom of this page, and report this issue to our Sevadaars to fix it before others face it.`,
