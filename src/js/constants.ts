...
export const TEXTS = {
  ...
  CONTROLLER_DESC:'Bani Controller lets you control SikhiToTheMax from your mobile devices. Sit anywhere in the Darbar Hall with the sangat or with the Keertani whilst still being able to control SikhiToTheMax. Bani Controller adds much more flexibility and mobility to project Gurbani on to the big screen.',
