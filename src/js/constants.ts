...
export const TEXTS = {
  ...
  CONTROLLER_DESC:'Bani Controller lets you control SikhiToTheMax from your mobile devices allowing you to be able to leave your computer on and control SikhiToTheMax without having to be physically near it. Sit anywhere in the Darbar Hall with the sangat or Keertani whilst still being able to control SikhiToTheMax. Bani Controller adds flexibility and mobility to project Gurbani on to the big screen.',
